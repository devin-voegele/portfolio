...
// ── Static fallback for mobile / perf-off / reduced-motion ────────────────────
function GlowOrb() {
  return (
    <div
      aria-hidden
    ...
    >
      <div
        style={{
          ...
          borderRadius: '9999px',
          background:
            'radial-gradient(circle at 40% 40%, rgba(46,107,255,0.55), rgba(139,92,246,0.35) 50%, transparent 75%)',
          filter: 'blur(24px)',
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── Two-column grid (lg) / stacked (mobile) ──────────────── */}
      <div
        className="relative mx-auto w-full lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center"
        style={{ zIndex: 10, maxWidth: '72rem' }}
      >
        ...
        {/* ── RIGHT COLUMN — 3D object (desktop only) ──────────────── */}
